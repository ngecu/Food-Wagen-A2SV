...
export const Header: React.FC = () => {
  ...
  return (
    <>
    <div className="food-header bg-white shadow-sm md:container md:mx-auto ">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="food-logo flex items-center">
            <div className="food-logo-image relative">
              <Image
                src="/images/logo.png" // Your custom logo
    ...
    {/* Hero Section */}
      <section className="hero-section w-full bg-primary-yellow">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            {/* Text Content */}
            <div className="header-title-container flex-1 text-center lg:text-left">
            ...
            <div className="hero-section-card">
                ...
                <div className="delivery-type-selector mb-8">
                    <div className="flex space-x-4 justify-center lg:justify-start">
                    <button
                        onClick={() => setDeliveryType('delivery')}
                        className={`food-delivery-btn px-6 py-3 rounded-2xl font-semibold text-lg transition-all duration-200 ${
...
<path d="M12.375 5.625H15.75V15.1875C15.75 16.7695 14.4844 18 12.9375 18H2.8125C1.23047 18 0 16.7695 0 15.1875V5.625H3.375V4.5C3.375 2.03906 5.37891 0 7.875 0C10.3359 0 12.375 2.03906 12.375 4.5V5.625ZM5.625 4.5V5.625H10.125V4.5C10.125 3.26953 9.10547 2.25 7.875 2.25C6.60938 2.25 5.625 3.26953 5.625 4.5ZM11.25 8.71875C11.707 8.71875 12.0938 8.36719 12.0938 7.875C12.0938 7.41797 11.707 7.03125 11.25 7.03125C10.7578 7.03125 10.4062 7.41797 10.4062 7.875C10.4062 8.36719 10.7578 8.71875 11.25 8.71875ZM4.5 8.71875C4.95703 8.71875 5.34375 8.36719 5.34375 7.875C5.34375 7.41797 4.95703 7.03125 4.5 7.03125C4.00781 7.03125 3.65625 7.41797 3.65625 7.875C3.65625 8.36719 4.00781 8.71875 4.5 8.71875Z" fill="#757575"/>
 ...
 Pickup
                ...
                <div className="search-section">
                    ...
                    <div className="food-search-container max-w-2xl">
                    <div className="relative">
                        ...
                        />
                        <button className="food-search-btn absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-600 transition-colors duration-200">
                        <div className='flex'>
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                    </svg>
            ...
            {/* Image Content */}
            <div className="header-image-container flex-1 flex justify-center lg:justify-left">
              <div className="relative">
                <Image
                  ...
                  width={500}
                  height={400}
                  className="header-image w-full max-w-md lg:max-w-lg object-contain"
                  priority
                />
              </div>
            </div>
