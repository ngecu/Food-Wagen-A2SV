...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  onShowSuggestionsChange
    ...
    const handleInputChange = (value: string) => {
        ...
        // Trigger search as user types (you can add debouncing here if needed)
        if (value.length >= 2) {
            onSearch(value);
        }
    };
            ...
            <section className="food-hero-section w-full bg-primary-yellow relative mt-16">
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:px-12" style={{
                    ...
                    <div className="flex items-center justify-left text-left">
                        {/* Text Content */}
                        <div className="food-header-title-container max-w-4xl mb-8 md:mb-12" >
                        ...
                        {/* Image Content */}
                        <div className="food-header-image-container max-w-4xl h-full hidden md:flex" style={{display: "flex", alignItems: "flex-end"}}>
                            <img 
