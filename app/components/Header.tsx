...
export const Header: React.FC<HeaderProps> = ({ onAddMealClick }) => {
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <section className="food-hero-section w-full bg-primary-yellow relative">
                <div className="container mx-auto px-4 h-full" style={{
                    ...
                    {/* Centered Content */}
                    <div className="flex items-center justify-left text-left pt-8 md:pt-12">
                        {/* Text Content */}
                        <div className="food-header-title-container max-w-4xl mb-8 md:mb-12" style={{width:"75%",padding: "1% 0"}}>
                            ...
                            <div className="food-hero-card bg-white rounded-3xl shadow-lg p-6 md:p-8 max-w-4xl mx-auto">
                                {/* Delivery Type Selector */}
                                <div className="food-delivery-type-selector mb-6 md:mb-8 w-full">
                                    <div className="flex space-x-4 justify-left">
                                        <button
                                            onClick={() => setDeliveryType('delivery')}
                                            className={`food-delivery-btn px-6 py-3 rounded-2xl font-semibold text-lg transition-all duration-200 flex items-center space-x-2  ${
                                        ...
                                        <button
                                            ...
                                            className={`food-pickup-btn px-6 py-3 rounded-2xl font-semibold text-lg transition-all duration-200 flex items-center space-x-2 ${
                                                deliveryType === 'pickup'
                                                    ? 'bg-orange-50 text-orange-600 border-orange-600'
                                                    : 'bg-white text-gray-700'
                                            }`}
                                ...
                                <div className="food-search-section w-full">
                                    <div className="food-search-container w-full max-w-2xl mx-auto">
                                        <div className="relative">
                                            ...
                                            />
                                            <button 
                                                className="food-search-btn absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-600 transition-colors duration-200 flex items-center space-x-2"
                        ...
                        {/* Image Content */}
                        <div className="food-header-image-container max-w-4xl h-full">
                            <img 
